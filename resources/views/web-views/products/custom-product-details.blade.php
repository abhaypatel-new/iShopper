...
@push('css_or_js')
    ...
    @if($product['image']!=null)
        <meta property="og:image" content="{{asset("storage/app/public/product/meta")}}/{{$product->images}}"/>
    ...
    @else
        ...
        <meta property="twitter:title" content="{{$product->name}}"/>
    @endif
    <meta property="og:url" content="{{route('custom-product',[$product->id])}}">

    
    <meta property="twitter:url" content="{{route('product',[$product->id])}}">
    ...
    <div class="container mt-4 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        ...
        <div class="row" style="direction: ltr">
                                    ...
                                    @foreach (json_decode($product->images) as $key => $photo)
                                        ...
                                        <div
                                            ...
                                            <img class="cz-image-zoom img-responsive" style="width:100%;height:auto"
                                                ...
                                                data-zoom="{{asset("storage/app/public/custom/product/$photo")}}"
                            ...
                            <div class="mb-3">
                                ...
                                @if($product->discount > 0)
                                    <strike style="color: #E96A6A;" class="{{Session::get('direction') === "rtl" ? 'ml-1' : 'mr-3'}}">
                                        ...
                                        {{\App\CPU\Helpers::currency_converter($product->offers)}}
                                    </strike>
                                @endif
                                <span
                                    class="h3 font-weight-normal text-accent ">
                                    {{\App\CPU\Helpers::get_custom_price_range($product) }}
                                </span>
                                <span class="{{Session::get('direction') === "rtl" ? 'mr-2' : 'ml-2'}}"
                                    style="font-size: 12px;font-weight:400">
                                    (<span>{{\App\CPU\translate('vat')}} : </span>
                                ...
                                <div class=" mt-1">
                                    ...
                                    <div class="px-4 pt-lg-3 pb-3 mb-3 mr-0 mr-md-2" style="background: #ffffff;border-radius:10px;min-height: 817px;">
                                        <div class="tab-content px-lg-3">
                                            ...
                                            @php($reviews_of_product = App\Model\Review::where('custom_product_id',$product->id)->paginate(2))
                                            <!-- Reviews tab-->
            ...
            <div class="col-md-3 ">
                ...
                <div style="background: #ffffff; padding: 25px;border-radius: 5px;
                    ...
                    @if($product->added_by=='customer')
                        ...
                        <div class="row d-flex justify-content-between">
                            ...
                            @php($products_for_review = App\Model\CustomProduct::where('added_by','admin')->where('user_id',$product->user_id)->withCount('reviews')->get())
                ...
                @php($more_product_from_customer = App\Model\CustomProduct::where('added_by',$product->added_by)->where('user_id',$product->user_id)->latest()->take(5)->get())
                <div style="padding: 25px;">
                ...
                <div style="">
                    ...
                    @foreach($more_product_from_customer as $item)
