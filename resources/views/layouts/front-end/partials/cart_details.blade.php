...
<div class="row">
    ...
    <section class="col-lg-8">
            ...
            <div class="cart_information mb-3">
                ...
                @foreach($group as $cart_key=>$cartItem)0
                                ...
                                <td>
                                   <div class="d-flex">
                                        <div style="width: 30%;">
                                            ...
                                            @else
                                             <a href="{{route('product',$cartItem['custom_product_id'])}}">
                                                <img style="height: 62px;"
                                                        src="{{asset('storage/app/public/custom/product')}}/{{$cartItem['images']}}"
                                                        alt="Product">
                                            </a>
                                            @endif
                                        </div>
                                        ...
                                        @else
                                         <div class="ml-2 text-break" style="width:70%;">
                                            <a href="{{route('product',$cartItem['custom_product_id'])}}">{{$cartItem['name']}}</a>
                                ...
                                <td>
                                    <div>
                                        <select name="quantity[{{ $cartItem['id'] }}]" id="cartQuantity{{$cartItem['id']}}"
                                                onchange="updateCartQuantitys('{{$cartItem['id']}}')">
                                            @for ($i = 1; $i <= 10; $i++)
                                                <option
