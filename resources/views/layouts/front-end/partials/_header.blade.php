...
<header class="box-shadow-sm rtl">
    ...
    <div class="navbar-sticky bg-light mobile-head">
        <div class="navbar navbar-expand-md navbar-light" style="background-color: #131921;">
            <div class="container ">
                ...
                <button class="btn btn-sm border border-white" style="border-radius: 57px;
    height: 46px;
    width: 125px;
    font-size: 11px;
    padding: 1px;background-color:#131921 !important;">
                             
                              <a class="nav-link text-capitalize" href="{{route('customer_products')}}">Custom Products</a>
                         </button>
                <!-- Toolbar-->
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    <ul class="navbar-nav" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                        ...
                        @endif
                          <!--  @if(auth('customer')->check())
                            <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                                <a class="nav-link text-capitalize" href="{{route('customer_products')}}">{{ \App\CPU\translate('Custom Products')}}</a>
                            </li>
