...
class CustomerController extends Controller
{
   ...
   // print_r($request->all());die;
       ...
       $Cproduct->name = $request->name;
         ...
         $Cproduct->quantity = $request->quantity;
        ...
        if ($request->ajax()) {
            ...
            $Cproduct->save();
                    ...
                    $customes = DB::table('custom_products')->get();
      //print_r($customes);die();           
             // Toastr::success('Product added successfully!');
           return response()->json(['data'=>$customes, 'msg'=>'product done'], 200);
