...
Route::group(['namespace' => 'Web', 'middleware' => ['maintenance_mode']], function () {
    ...
    Route::group(['middleware' => ['customer']], function () {
        ...
        // Route::post('customerstores','WebController@customerstores')->name('customerstores');
    ...
    Route::get('/cproduct/{slug}', 'WebController@Custom_product')->name('custom-product');
    Route::get('products', 'WebController@products')->name('products');
    Route::get('cproducts', 'WebController@Custom_products')->name('custom-products');
    ...
    Route::post('review-list-product', 'WebController@review_list_product')->name('review-list-product');
     Route::post('video', 'WebController@chat_video')->name('video');
...
Route::group(['prefix' => 'cart', 'as' => 'cart.', 'namespace' => 'Web'], function () {
    ...
    Route::post('addcustom', 'CartController@addcustom')->name('addcustom');
    ...
    Route::post('updateCustomQuantity', 'CartController@updateCustomQuantity')->name('updateCustomQuantity');
});
...
/*--------------Start Custom Product----------------------*/
 Route::get('get-categories', 'CustomProductController@get_categories')->name('get-categories');
Route::get('customer_products', 'CustomProductController@customer_products')->name('customer_products');
Route::post('delete-custom', 'CustomProductController@deleteCustom')->name('delete-custom');
Route::get('custom-product-edit/{id}', 'CustomProductController@custom_edit')->name('custom-edit');
Route::post('custom-product-update', 'CustomProductController@custom_update')->name('custom-update');
Route::post('customerstore', 'CustomProductController@customerstore')->name('customerstore');
Route::get('custom_product_list', 'CustomProductController@custom_product_list')->name('custom_product_list');
 Route::get('view_offer', 'CustomProductController@view_offer')->name('view_offer');
Route::get('view_custom', 'CustomProductController@view_custom')->name('view_custom');
