...
Route::group(['namespace' => 'Seller', 'prefix' => 'seller', 'as' => 'seller.'], function () {
    ...
    Route::group(['middleware' => ['seller']], function () {
        ...
        Route::get('/add-custom-data', 'SystemController@add_custom_data')->name('add-custom-data');
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.'], function () {
            ...
            // Route::post('custom-status-update', 'ProductController@custom_status_update')->name('custom-status-update');
            // Route::get('get/custom/product', [CustomProductController::class, 'index'])->name('custom.list');
            //  Route::get('get-custom-product/{status}', [CustomProductController::class, 'custom_list'])->name('c.list');
            // Route::post('seller/offer/{id}', 'ProductController@CCustomProductupdate')->name('custom.update');
            // Route::get('edit/custom/product/{id}', [CustomProductController::class, 'edit'])->name('custom.edit');
            // Route::get('remove-custom-image', 'ProductController@remove_custom_image')->name('remove-custom-image');
            // Route::delete('custom-delete/{id}', 'ProductController@custom_delete')->name('custom.delete');
            // Route::get('custom/view/{id}', 'ProductController@custom_view')->name('custom-view');
             Route::post('custom-status-update', 'ProductController@custom_status_update')->name('custom-status-update');
            Route::get('get/custom/product', [CustomProductController::class, 'index'])->name('custom.list');
             Route::get('get-custome/{checked}', [CustomProductController::class, 'getcustom'])->name('custom.get.list');
            Route::post('seller/offer/{id}', 'ProductController@CCustomProductupdate')->name('custom.update');
            Route::get('edit/custom/product/{id}', [CustomProductController::class, 'edit'])->name('custom.edit');
            Route::get('remove-custom-image', 'ProductController@remove_custom_image')->name('remove-custom-image');
            Route::delete('custom-delete/{id}', 'ProductController@custom_delete')->name('custom.delete');
            Route::get('custom/view/{id}', 'ProductController@custom_view')->name('custom-view');
            Route::post('custom/insert_bid', 'ProductController@insert_bid')->name('insert_bid');
